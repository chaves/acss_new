<script lang="ts">
	...
	const breadcrumbSchema = $derived(
		generateBreadcrumbSchema([
			...
			{ name: 'Digital Regulation Workshop', url: '/seminaires/digital-regulation' },
			{ name: seminar.title, url: `/seminaires/digital-regulation/${seminar.slug}` }
		])
	);
</script>

<SEO
	title="Digital Regulation: {seminar.title} | Institut ACSS-PSL"
	description={seoDescription}
	type="article"
/>
...
<Breadcrumb
	...
	link_text={m.digital_regulation()}
/>
...
<article class="seminar-detail">
	...
	<!-- Workshop Info Card -->
	<WorkshopInfo type="digitalReg" variant="section" showRegistration={!isPast} />

	<!-- Back link -->
	<div class="back-link">
		<a href="/seminaires/digital-regulation">
			<svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
				<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
			</svg>
			Back to all Digital Regulation sessions
		</a>
	</div>
</article>
