...
<svelte:head>
	<title>Public Governance: {seminar.title} | Institut ACSS-PSL</title>
...
<style>
	...
	.presenter-homepage {
		@apply text-sm text-purple-600 hover:text-purple-700 hover:underline break-all;
	}
	...
	.back-link a {
		@apply inline-flex items-center gap-2 text-purple-600 hover:text-purple-700;
	}
